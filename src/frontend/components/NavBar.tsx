import { ChartColumnStacked, Heart, Home, LogIn } from "lucide-react";
...
function NavBar() {
  ...
  return (
    <nav className="top-0 w-full h-16 bg-gradient-to-r to-primary-500 from-secondary-500 flex">
      <div className="container mx-auto h-full flex items-center justify-center">
        ...
        <NavLink to="/" className="flex items-center h-full gap-3">
          ...
          <div className="text-white text-xl font-bold">Трекер привычек</div>
        </NavLink>
      </div>
